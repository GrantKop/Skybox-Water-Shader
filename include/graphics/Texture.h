...
class Texture {
    ...
    public:
        Texture(std::vector<std::string> faces, GLenum texType, GLuint texSlot, GLenum format, GLenum pixelType, GLenum minMagFilter = GL_NEAREST, GLenum wrapFilter = GL_REPEAT);
        ~Texture(); 
